function global_loocv_batch(startPos, endPos)
    ...
    globalPosition = GetGlobalPosition_batch(A, D, miR_disease_matrix, pIndex, startPos, endPos);
    fileName = sprintf('output/globalPos_%d_%d.mat', startPos, endPos);
    save(fileName, 'globalPosition');
