...
fcvPosition = GetFiveFoldPosition(A, D, miR_disease_matrix, pIndex);

F_AUC = Fpositiontooverallauc(miR_disease_matrix, pIndex, fcvPosition);

save('output/fcvPosition.mat','fcvPosition');
